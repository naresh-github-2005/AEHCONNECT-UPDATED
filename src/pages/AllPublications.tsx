...
import { 
  ...
  FileText, Users, Link as LinkIcon, Share2, Copy, Mail, MessageCircle
} from 'lucide-react';
                    ...
                    <div className="border-t px-4 pb-4 space-y-3">
                      {doctor.publications.map((pub) => (
                        <div key={pub.id} className="flex items-start gap-3 pt-3 border-t first:border-t-0 first:pt-3">
                          ...
                          <Button variant="ghost" size="icon" className="h-8 w-8 shrink-0" onClick={() => handleShare(pub)} title="Share">
